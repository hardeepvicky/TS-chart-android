package in.co.sevenrocks.tschart.http;
...
import in.co.sevenrocks.tschart.config.Constant;
import in.co.sevenrocks.android.AsyncTaskHandler;
import in.co.sevenrocks.android.collection.LinkedHashMapHelper;
import in.co.sevenrocks.android.collection.WebExceptionEntity;
import in.co.sevenrocks.android.http.WebRequest;
...
public class WebApi
{
    ...
    public static String baseUrl = Constant.domain + "/web-api";
